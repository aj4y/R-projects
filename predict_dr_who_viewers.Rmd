...
episodes_joined %>% 
  ...
  ggplot(aes(mean_rating,writer))+geom_errorbarh(aes(xmax = max_rating,xmin = min_rating))
...
episodes_joined %>% 
  ...
  ggplot(aes(mean_rating,director))+geom_errorbarh(aes(xmax = max_rating,xmin = min_rating))
